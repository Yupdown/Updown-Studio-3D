...
RiggedVertex::RiggedVertex(const XMFLOAT3& position, const XMFLOAT2& uv, const XMFLOAT3& normal, const XMFLOAT3& tangent, const char boneIndices[4], const XMFLOAT4& boneWeights)
{
	this->position = position;
	this->uv = uv;
	this->normal = normal;
