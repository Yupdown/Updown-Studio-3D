...
namespace udsdx
{
	...
	struct RiggedVertex
	{
		...
		RiggedVertex();
		RiggedVertex(const XMFLOAT3& position, const XMFLOAT2& uv, const XMFLOAT3& normal, const XMFLOAT3& tangent, const XMUINT4& boneIndices, const XMFLOAT4& boneWeights);
	};
}